...
final class MainViewController: UIViewController, WKNavigationDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let url = URL(string: "https://oauth.vk.com/authorize?client_id=51695712&redirect_uri=https://oauth.vk.com/blank.html&scope=friends,groups,photos&display=mobile&response_type=token") {
